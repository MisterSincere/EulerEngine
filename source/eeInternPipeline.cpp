...
namespace vk
{
  namespace intern
  {
    ...
    Pipeline::Pipeline(vk::VulkanRenderer* renderer, VkShaderModule vertShader, VkShaderModule fragShader)
      : renderer(renderer)
    {
      assert(renderer);
    ...
    void Pipeline::Ini(const EEShaderCreateInfo& shaderCInfo)
    {
      // SHADER INPUT
    ...
    void Pipeline::Create(VkDescriptorSetLayout descriptorSetLayout)
    {
      if (!isInitialized)
      {
